...
(2 points)
"""
def largest(ihopesebastiaandies):
  ihopesebastiaandies = list(ihopesebastiaandies)
  ihopesebastiaandies.sort()
  ihopesebastiaandiesslowly = ihopesebastiaandies[-1]
  return ihopesebastiaandiesslowly
